...
<body>
    ...
    <main>
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="./images/Steak.jpg" width="100%" id="ProductImg">
                </div>


                <div class="col-2">
                    <h2><a href="./index.php">Home</a>/<a href="./p2_MeatAisle.php">Meat</a>/Steak</h2>
                    <h1>AAA Angus Steak</h1>
                    <h4 style="display: none;" id="unitPrice">36.50</h4>
                    <h4 class="product-price">$36.50 /<span>kg</span>
                    </h4>
                    <br>
