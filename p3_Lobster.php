...
<body>
    ...
    <main>
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="./images/Lobster.jpg" width="100%" id="ProductImg">
                </div>


                <div class="col-2">
                    <h2><a href="./index.php">Home</a>/<a href="./p2_SeafoodAisle.php">Seafood</a>/Lobster</h2>
                    <h1>Lobster</h1>
                    <h4 style="display: none;" id="unitPrice">34.30</h4>
                    <h4 class="product-price">$34.30 /<span>unit</span>
                    </h4>
                    <br>
