    ...
    <main>
        ...
        <div class="small-container single-product">
            <div class="row">
                ...
                <div class="col-2">
                    <h2><a href="./index.php">Home</a>/<a href="./p2_DairyAisle.php">Dairy</a>/Cheese</h2>
                    <h1>Brie Cheese</h1>
                    <h4 style="display: none;" id="unitPrice">7.38</h4>
                    <h4 class="product-price">$7.38 /<span>unit</span>
                    </h4>
                    <br>
