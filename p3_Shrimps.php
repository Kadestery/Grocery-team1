...
<body>
    ...
    <main>
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="./images/Shrimps.jpg" width="100%" id="ProductImg">
                </div>


                <div class="col-2">
                    <h2><a href="./index.php">Home</a>/<a href="./p2_SeafoodAisle.php">Seafood</a>/Shrimps</h2>
                    <h1>Shrimps</h1>
                    <h4 style="display: none;" id="unitPrice">8.97</h4>
                    <h4 class="product-price">$8.97 /<span>bag</span>
                    </h4>
                    <br>
                    <input id="quantity" type="number" min="0" value="1" onchange="updatePrice();saveValue(this)"> <a href="" class="btn">Add To Cart</a>
                    <br>
