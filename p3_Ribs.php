...
<body>
    ...
    <main>
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="./images/Ribs.jpg" width="100%" id="ProductImg">
                </div>


                <div class="col-2">
                    <h2><a href="./index.php">Home</a>/<a href="./p2_MeatAisle.php">Meat</a>/Pork Ribs</h2>
                    <h1>Pork Ribs</h1>
                    <h4 style="display: none;" id="unitPrice">7.49</h4>
                    <h4 class="product-price">$7.49 /<span>pack</span>
                    </h4>
                    <br>
