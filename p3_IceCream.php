...
<body>
    ...
    <main>
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="./images/ChocoIceCream.jpg" width="100%" id="ProductImg">
                </div>


                <div class="col-2">
                    <h2><a href="./index.php">Home</a>/<a href="./p2_DairyAisle.php">Dairy</a>/Ice Cream</h2>
                    <h1>Chocolate Ice Cream</h1>
                    <h4 style="display: none;" id="unitPrice">6.50</h4>
                    <h4 class="product-price">$6.50 /<span>unit</span>
                    </h4>
                    <br>
