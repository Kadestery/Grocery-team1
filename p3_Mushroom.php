...
<body>
    ...
    <main>
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="./images/mush.jpg" width="100%" id="ProductImg">
                </div>


                <div class="col-2">
                    <h2><a href="./index.php">Home</a>/<a href="./p2_VegetablesAisle.php">Vegetables</a>/Mushrooms
                    </h2>
                    <h1>Mushrooms</h1>
                    <h4 style="display: none;" id="unitPrice">2.49</h4>
                    <h4 class="product-price">$2.49 /<span>pack</span>
                    </h4>
                    <br>
        ...
        <section>
            ...
            <div class="row2">
                ...
                <div class="col-5">
                    <div class="product">
                        <a href="./p3_RedPepper.php">
                            <img src="./images/RedPepper.jpg" alt="Red Pepper">
                            <h4 class="aisle-text">Red Peppers</h4>
                            <p class="aisle-text">$1.18/unit</p>
                        </a>
                    </div>
                </div>
