...
<body>
    ...
    <main>
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="./images/Bacardi.jpg" width="100%" id="ProductImg">
                </div>


                <div class="col-2">
                    <h2><a href="./index.php">Home</a>/<a href="./p2_WaterAisle.php">Drinks</a>/Bacardi Rhum</h2>
                    <h1>Bacardi Rhum 1.14L</h1>
                    <h4 style="display: none;" id="unitPrice">36.00</h4>
                    <h4 class="product-price">$36.00 /<span>unit</span>
                    </h4>
                    <br>
