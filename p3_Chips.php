...
<body>
    ...
    <main>
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="./images/Chips.jpg" width="100%" id="ProductImg">
                </div>


                <div class="col-2">
                    <h2><a href="./index.php">Home</a>/<a href="./p2_SnacksAisle.php">Snacks</a>/Chips</h2>
                    <h1>BBQ Chips</h1>
                    <h4 style="display: none;" id="unitPrice">4.59</h4>
                    <h4 class="product-price">$4.59 /<span>bag</span>
                    </h4>
                    <br>
