...
<body>
    ...
    <main>
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="./images/Danish.jpg" width="100%" id="ProductImg">
                </div>


                <div class="col-2">
                    <h2><a href="./index.php">Home</a>/<a href="./p2_PastryAisle.php">Pastry</a>/Danish</h2>
                    <h1>Plain Danish</h1>
                    <h4 style="display: none;" id="unitPrice">1.50</h4>
                    <h4 class="product-price">$1.50 /<span>unit</span>
                    </h4>
                    <br>
