...
<body>
    ...
    <div>
        <h1 class="bs-header"></br>Add a user
            ...
            <form action="" class="bs-add">
                <p>
                    ...
                    <input class="data-entering" type="text" name="itemdata[]" value="" id="email" />
                </p>
            </form>
            ...
            <form action="" class="bs-add">
                <p>
                    ...
                    <input class="data-entering" type="text" name="itemdata[]" value="" id="password" />
                </p>
            </form>
