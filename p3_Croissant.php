...
<body>
    ...
    <main>
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="./images/Croissant.jpg" width="100%" id="ProductImg">
                </div>


                <div class="col-2">
                    <h2><a href="./index.php">Home</a>/<a href="./p2_PastryAisle.php">Pastry</a>/Croissant</h2>
                    <h1>Croissant</h1>
                    <h4 style="display: none;" id="unitPrice">1.75</h4>
                    <h4 class="product-price">$1.75 /<span>unit</span>
                    </h4>
                    <br>
