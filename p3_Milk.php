...
<body>
    ...
    <main>
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="./images/Milk.jpg" width="100%" id="ProductImg">
                </div>


                <div class="col-2">
                    <h2><a href="./index.php">Home</a>/<a href="./p2_DairyAisle.php">Dairy</a>/Milk</h2>
                    <h1>Milk</h1>
                    <h4 style="display: none;" id="unitPrice">5.03</h4>
                    <h4 class="product-price">$5.03 /<span>unit</span>
                    </h4>
                    <br>
        ...
        <section>
            ...
            <div class="row2">
                ...
                <div class="col-5">
                    <div class="product">
                        <a href="./p3_Cheese.php">
                            <img src="./images/Cheese.jpg" alt="Cheese">

                            <h4 class="aisle-text">Brie Cheese</h4>
                            <p class="aisle-text">$7.38/unit</p>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-5">
                    <div class="product">
                        <a href="./p3_IceCream.php">
                            <img src="./images/ChocoIceCream.jpg" alt="Chocolate Ice Cream">
                            <h4 class="aisle-text">Chocolate Ice Cream</h4>
                            <p class="aisle-text">$6.50/unit</p>
                        </a>
                    </div>
                </div>
