...
<body>
    ...
    <main>
        ...
        <div class="small-container single-product">
            <div class="row">
                <div class="col-2">
                    <img src="./images/WaterFiji.jpg" width="100%" id="ProductImg">
                </div>


                <div class="col-2">
                    <h2><a href="./index.php">Home</a>/<a href="./p2_WaterAisle.php">Drinks</a>/Water</h2>
                    <h1>Fiji Water</h1>
                    <h4 style="display: none;" id="unitPrice">4.99</h4>
                    <h4 class="product-price">$4.99 /<span>unit</span>
                    </h4>
                    <br>
